...
/*
 * url: http://tartarus.org/martin/PorterStemmer/java.txt
 *
...
public class PorterStemmerTTT {
	...
	public static void main(String[] args){
		PorterStemmerTTT s = new PorterStemmerTTT();
		char[] w = "funniest".toCharArray();
		s.add(w, w.length);
		s.stem();
