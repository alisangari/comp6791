...
/*
 * This singleton class holds values for all variables that are used in BM25 equation.
 * The variables not included here are related to the current document (ie. L_d). 
 */
public class BM25 {
