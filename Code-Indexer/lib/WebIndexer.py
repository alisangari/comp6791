...
https://code.google.com/p/website-clustering/source/browse/trunk/src/WebIndexer.py by Marc-Andre Faucher
"""
...
class WebIndexer:
    ...
    def __init__(self, folder='encs.concordia.ca/mystery-pages', blockSize=1):
        """ ReuterIndexer
